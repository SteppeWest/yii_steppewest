...
<div class="link-index">
	...
	$gridColumn = [
		...
		[
				...
				'filter' => \yii\helpers\ArrayHelper::map(\common\models\Subgroup::find()->asArray()->all(), 'subgroup_id', 'name'),
				'filterWidgetOptions' => [
					'pluginOptions' => ['allowClear' => true],
				],
				'filterInputOptions' => ['placeholder' => 'P2m subgroup', 'id' => 'grid-link-search-subgroup_id']
			],
		'name',
		'title',
		'link',
