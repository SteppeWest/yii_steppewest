...
?>
<div class="giiant-crud link-view">
	...
	<?= Html::a('<span class="glyphicon glyphicon-trash"></span> ' . 'Delete', ['delete', 'link_id' => $model->link_id],
	[
...
<?php Pjax::begin(['id'=>'pjax-Subgroup', 'enableReplaceState'=> false, 'linkSelector'=>'#pjax-Subgroup ul.pagination a, th a']) ?>
<?=
...
[
	...
	'label'   => '<small>Subgroup <span class="badge badge-default">'. $model->getSubgroup()->count() . '</span></small>',
	'active'  => false,
],
 ]
				]
